...
class HeroAndCollapse extends StatefulWidget {
  @override
  _HeroAndCollapseState createState() => _HeroAndCollapseState();
}

class _HeroAndCollapseState extends State<HeroAndCollapse> {
        ...
        slivers: <Widget>[
          new SliverAppBar(
            ...
            flexibleSpace: new FlexibleSpaceBar(
              title: new Text('Hero & Collapse'),
              background: new Image.network(
                  'https://u.tfstatic.com/restaurant_photos/239/221239/169/612/restaurant-puur-het-restaurant-2ba49.jpg',
                  fit: BoxFit.cover),
            ),
          ),
          new SliverPadding(
  ...
  Widget _buildColumn1(OrderItem itm) {
    return new Column(
      children: <Widget>[
        new Padding(
          padding: new EdgeInsets.only(left: 5.0, right: 15.0, top: 5.0),
          child: new InkWell(
            child: new Hero(
